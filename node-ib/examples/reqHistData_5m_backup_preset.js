 ...
 // setInterval(function(){
    ...
    event.on('forex_buy_and_sell:app',function(data){
      ...
      if(check_if_buy_or_sell_in_place==data.signal && coin==data.name ){
		...
		ib.placeOrder(orderid++,ib.contract.forex(data.name),ib.order.market(data.signal,10000));
                fs.appendFileSync('/IB_TI/node-talib-0.4.0/examples/signals.txt','take profit in ' + data.name + '-' + data.signal + ' bought 10000' + ' '+ new Date()  + '\n');
             ...
             ib.placeOrder(orderid++,ib.contract.forex(data.name),ib.order.market(data.signal,10000));
             fs.appendFileSync('/IB_TI/node-talib-0.4.0/examples/signals.txt',data.name + '-' + data.signal + ' bought 10000' + ' '+ new Date()  + '\n');
             }
         } else {
             //  ib.cancelOrder(orderid);
              // ib.cancelOrder(orderid-1);
...
ib.reqHistoricalData(1,  ib.contract.forex('GBP'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(2,  ib.contract.forex('EUR'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(3,  ib.contract.forex('CAD'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(4,  ib.contract.forex('JPY'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(5,  ib.contract.forex('AUD'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(6,  ib.contract.forex('CHF'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(7,  ib.contract.forex('NZD'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(8,  ib.contract.forex('KRW'),dateformat(now,"yyyymmdd H:MM"),durationStr='3600 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
...
ib.reqHistoricalData(1,  ib.contract.forex('GBP'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(2,  ib.contract.forex('EUR'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(3,  ib.contract.forex('CAD'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(4,  ib.contract.forex('JPY'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(5,  ib.contract.forex('AUD'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(6,  ib.contract.forex('CHF'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(7,  ib.contract.forex('NZD'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(8,  ib.contract.forex('KRW'),dateformat(now,"yyyymmdd H:MM"),durationStr='850 S',barSizeSetting='5 mins',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
},300000);
*/
});
