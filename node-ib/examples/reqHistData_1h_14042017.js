...
ib.reqHistoricalData(1,  ib.contract.forex('GBP'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(2,  ib.contract.forex('EUR'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(3,  ib.contract.forex('CAD'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(4,  ib.contract.forex('JPY'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(5,  ib.contract.forex('AUD'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(6,  ib.contract.forex('CHF'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(7,  ib.contract.forex('NZD'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
ib.reqHistoricalData(8,  ib.contract.forex('KRW'),dateformat(now,"yyyymmdd H:MM"),durationStr='3300 S',barSizeSetting='1 hour',whatToShow='MIDPOINT',useRTH=1,formatDate=1);
